...
\begin{document}
	...
	\begin{lstlisting}[label=code-par-even,caption=Функция потока вычисления строки при чётных размерах матрицы]
	...
	\begin{lstlisting}[label=code-par-odd,caption=Функция потока вычисления строки при нечётных размерах матрицы]
